...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002017463720').split()]
...
IMDB = is_enabled((environ.get('IMDB', "Fase")), True)
...
SESSION_NAME = str(environ.get('SESSION_NAME', 'NMoviesPProviderBoT'))
MULTI_CLIENT = False
name = str(environ.get('name', 'NMoviesPProviderBoT'))
